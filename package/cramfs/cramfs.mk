...
CRAMFS_SITE = http://downloads.sourceforge.net/project/cramfs/cramfs
...
define HOST_CRAMFS_BUILD_CMDS
	$(HOST_MAKE_ENV) $(MAKE) CFLAGS="$(HOST_CFLAGS)  -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64" LDFLAGS="$(HOST_LDFLAGS)" -C $(@D)
endef
