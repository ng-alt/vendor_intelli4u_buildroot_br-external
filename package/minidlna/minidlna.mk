...
define MINIDLNA_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) -C $(@D) \
		CFLAGS="$(ZIP_TARGET_CFLAGS) $(ZIP_CFLAGS) -D_GNU_SOURCE -I$(MINIDLNA_AVLIB_DIR) \
		-I$(MINIDLNA_AVLIB_DIR)/libavcodec -I$(MINIDLNA_AVLIB_DIR)/libavformat \
		-I$(SQLITE_DIR) -I$(LIBEXIF_DIR) -I$(LIBID3TAG_DIR) -I$(LIBOGG_DIR) -I$(LIBVORBIS_DIR) -I$(LIBJPEG_DIR) \
		-Iinclude" \
...
define MINIDLNA_INSTALL_TARGET_CMDS
	...
	ln -sf minidlnad $(TARGET_DIR)/usr/sbin/minidlna.exe
endef
