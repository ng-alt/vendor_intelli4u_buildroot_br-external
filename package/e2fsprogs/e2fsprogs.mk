...
E2FSPROGS_VERSION_FILE = version.h
E2FSPROGS_VERSION_PATTERN = "\#\s*define\s+E2FSPROGS_VERSION\s+\"([^\"]+)\""
...
E2FSPROGS_CONF_ENV += c_cv_lib_pthread_sem_init=no  BUILD_CFLAGS="-DHAVE_SYS_STAT_H"
...
define E2FSPROGS_INSTALL_TARGET_CMDS
	$(HOST_MAKE_ENV) $(MAKE) -C $(@D) DESTDIR=$(TARGET_DIR) install
endef
